// :feature:files — android-library + Compose. LLM.md §3.7.
...
android {
    namespace = "com.pion.phonecleaner.feature.files"
...
dependencies {
    ...
    // App icons on the app-manager rows: Coil through :core:ui's AppIconLoader, which exposes its
    // own ImageLoader. :core:ui keeps coil as `implementation`, so the composable needs its own.
